-- =========================================================================
-- NOVOS VÍDEOS DO PORTFÓLIO
--
-- COMO USAR: Supabase > SQL Editor > New query > cole tudo > Run.
-- Isso só ACRESCENTA linhas novas na tabela "videos". Não apaga nem
-- muda nenhum vídeo que já existia (como o da Iracema, se já estava
-- cadastrado antes: nesse caso você vai ver dois vídeos da Iracema
-- depois, e pode apagar o repetido direto no painel admin, aba
-- Portfólio, se for o caso).
--
-- Nenhum desses vídeos entra em "Destaques" automaticamente. Se
-- quiser destacar algum, é só abrir ele no painel admin (aba
-- Portfólio) e preencher o campo "Destaque" (ex: "2,4M views").
-- =========================================================================
...
insert into public.videos (titulo, link, nicho, formato, marca, ordem, visivel) values
  ...
  ('Wisecat', 'https://youtube.com/shorts/ZqLTrkfLrww?feature=share', 'Casa e Decoração', 'Vídeo vertical 9:16', 'Wisecat', 125, true),
  ('Iracema', 'https://youtube.com/shorts/nT27VFWlgfM?feature=share', 'Casa e Decoração', 'Vídeo vertical 9:16', 'Iracema', 126, true),
